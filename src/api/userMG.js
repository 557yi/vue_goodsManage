...
import { req, req1,Logreq } from './axiosFun';
const url = "http://192.168.43.226:8081"
// const url = "http://172.20.10.3:8081"
// 登录接口 
export const login = (params) => { return Logreq("post", url+"/user/login", params) };
// 获取用户菜单

...
import { req,url1,req2} from './axiosFun';
let url2 = 'http://192.168.43.226:8083'
// let url2 = 'http://172.20.10.3:8083'
/**
 * 支付配置信息
 **/
// 支付配置信息-获取支付配置信息列表
 ...
 **/
// 交易订单-获取交易订单列表
export const OrderList = () => { return req2("get",url2+"/order/listAll") };
// 交易订单-s删除交易订单

...
<template>
  <div>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="userName" label="提交订单人" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="productName" label="产品名" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="orderNum" label="商品数量" width="140" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="price" label="商品总价" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="status" label="订单状态" width="120" show-overflow-tooltip>
      </el-table-column>
      <el-table-column sortable prop="createdAt" label="创建时间" width="180" show-overflow-tooltip>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getdata(parameter) {
      ...
      console.log(resq)
      this.loading = false
      this.listData = resq.data
      this.pageparm.currentPage = this.formInline.page
      this.pageparm.pageSize = this.formInline.limit
      this.pageparm.total = resq.data.length
      res.count = resq.data.length
    })
